...
(function() { this.JST || (this.JST = {}); this.JST["landing"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('match container template in landing.jst.ejs\n');}return __p.join('');};
}).call(this);
