...
(function() {
  ...
  $(document).ready(function() {
    return RestaurantReviews.initialize();
  });

}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["feedback"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="feedback_trigger"></div>\n<div id="feedback_box" class="hidden">\n  <!-- TODO - render questions if any -->\n  <p>Any feedback would be very much appreciated!</p>\n  <textarea id="feedback_body" class="form-control" placeholder="e.g. the review system isn\'t intuitive, there aren\'t enough images etc."></textarea><br>\n  <button id="send_feedback" class="btn btn-primary">Send</button>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["landing"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="match_config">\n  <input type="text" id="subarea_autocomplete" class="form-control" />\n  <select id="categories_select" class="form-control" style=""></select>\n  <h4>',  I18n.match.instruction ,'</h4>\n  <div id="match_message"></div>\n</div>\n<br>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["match"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="text-center">\n  <div class="match-restaurant-box">\n    <div class="match-restaurant left-restaurant">\n      <div class="match-image left-image"></div>\n      <div id="left_win" class="left-description match-button"></div>\n    </div>\n  </div>\n  <div class="match-vs">VS</div>\n  <div class="match-restaurant-box">\n    <div class="match-restaurant right-restaurant">\n      <div class="match-image right-image"></div>\n      <div id="right_win" class="right-description match-button"></div>\n    </div>\n  </div>\n\n  <br>\n  <div id="match_extra_buttons">\n    <div class="never-been"><i id="left_never_been" class="match-button fa fa-lg fa-refresh"></i></div>\n    <div class="draw-button"><u id="draw" class="match-button ">',  I18n.match.draw ,'</u></div>\n    <div class="never-been"><i id="right_never_been" class="match-button fa fa-lg fa-refresh"></i></div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["matches"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p>',  I18n.match.delay ,'</p>\n<h4>',  I18n.match.instruction ,'</h4>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["restaurants/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="restaurant_container">\n  <h2>',  restaurant.escape('name') ,'</h2>\n  <br>\n  <div class="restaurant-info">\n    <div id="price" class="bullet-after">\n      <i class="fa fa-sun-o"></i>\n      ',  restaurant.escape('lunch_price') ,'\n    </div>\n    <i class="fa fa-moon-o"></i>\n    ',  restaurant.escape('dinner_price') ,'\n\n    <br>\n    <div id="tags">\n      ');  _.each(restaurant.attributes.categories, function(c) { ; __p.push('\n        ',  c.name ,'   <!-- TODO - link to category -->\n      ');  }) ; __p.push('   <!-- <a id="edit_tags" href="#">Edit</a> -->\n    </div>\n  </div>\n\n  <div class="restaurant-buttons" style="text-align: right;">\n    ');  var review_path = '/restaurants/' + restaurant.escape('id') + '/reviews/new'; ; __p.push('\n    ');  var images_path = '/restaurants/' + restaurant.escape('id') + '/restaurant_images/new'; ; __p.push('\n    <a href="',  review_path ,'" class="btn btn-primary">',  I18n.write_review ,'</a>\n    <div class="btn-group" role="group">\n      <a href="',  images_path ,'" id="add_image" class="btn btn-default"><i class="fa fa-camera"></i> ',  I18n.add_photo ,'</a>\n      <button id="share_restaurant" class="btn btn-default"><i class="fa fa-share"></i> ',  I18n.share ,'</button>\n      <button id="bookmark_restaurant" class="btn btn-default"><i class="fa fa-bookmark"></i> ',  I18n.bookmark ,'</button>\n    </div>\n  </div>\n\n  <br>\n  \n  <div id="restaurant_location">\n    <div id="restaurant_map"></div>\n    <div id="restaurant_address">\n      <p>',  restaurant.escape('display_address') ,'</p>\n      <p><i class="fa fa-phone"></i> ',  restaurant.escape('telephone') ,'</p>\n      <p><i class="fa fa-external-link"></i> <a href="',  restaurant.escape('home_page') ,'">',  restaurant.escape('home_page') ,'</a></p>\n      <p></p>\n      <p></p>\n    </div>\n  </div>\n  <div id="restaurant_images">\n    ');  var images = restaurant.attributes.images; ; __p.push('\n    ');  if (images.length > 0) { ; __p.push('\n      ');  _.each(images.slice(0, 2), function(image) { ; __p.push('\n        <div class="restaurant-image">\n          <img class="center-cropped" src="',  image.url ,'"/>\n        </div>\n      ');  }) ; __p.push('\n      <div class="restaurant-image">\n        <img class="center-cropped" src="',  images[images.length - 1].url ,'"/>\n      </div>\n    ');  } else { ; __p.push('\n      ',  I18n.no_images ,' <a href="',  images_path ,'" id="add_image" class="btn btn-default"><i class="fa fa-camera"></i> Add some!</a>\n    ');  } ; __p.push('\n  </div>\n\n  <br>\n\n  <div id="match_container">\n    <div id="match_stats">\n      <h2>',  I18n.scores ,'</h2>\n      <h3>',  restaurant.escape('positive_rate') ,'%</h3><div class="stat-description"> positive review</div>\n      <br>\n      ');  _.each(restaurant.attributes.stats, function(stat) { ; __p.push('\n        <h3>',  stat.win_rate ,'%</h3><div class="stat-description"> win rate in ',  stat.category_name ,'</div>\n      ');  }) ; __p.push('\n    </div>\n    <div id="match_form">\n      <h4>',  I18n.match.instruction ,'</h4>\n    </div>\n  </div>\n\n  <br>\n\n  <div class="info-row">\n    <div id="reviews_container">\n      <h4>',  I18n.reviews ,'</h4>\n      <ul id="restaurant_reviews">\n      </ul>\n    </div>\n    <div id="restaurant_details">\n      <table>\n        <tr>\n          <th>\n            Hours\n          </th>\n          <td>\n            ',  restaurant.escape('hours') ,'\n          </td>\n        </tr>\n        <tr>\n          <th>\n            Parking\n          </th>\n          <td>\n            ',  restaurant.escape('parking') ,'\n          </td>\n        </tr>\n        <tr>\n          <th>\n            Facilities\n          </th>\n          <td>\n            ',  restaurant.escape('facilities') ,'\n          </td>\n        </tr>\n        <tr>\n          <th>\n\n          </th>\n          <td>\n          </td>\n        </tr>\n      </table>\n    </div>\n  </div>\n</div>\n\n<style>\n@media (min-width: 1190px) {\n  #restaurant_container {\n    position: relative;\n    padding: 0em 3em 3em 3em;\n  }\n}\n@media (max-width: 1189px) {\n  #restaurant_container {\n    position: relative;\n    padding: 0em 0em 3em 0em;\n  }\n}\n\n#restaurant_map {\n  height: 12em;\n  width: 19em;\n  margin: 0;\n  padding: 0;\n}\n\n.restaurant-info {\n  position: relative;\n  top: 0;\n  left: 0;\n}\n\n.restaurant-info #price,\n.restaurant-info #tags {\n  display: inline-block;\n}\n\n.restaurant-buttons {\n  position: absolute;\n  right: 0em;\n  top: 2em;\n}\n\n#restaurant_location {\n  padding: 0.5em;\n  border: #aaa solid 1px;\n}\n\n#restaurant_location {\n  width: 20em;\n}\n\n#match_stats {\n  margin-top: 3em;\n  width: 20em;\n  height: 22em;\n  background-color: #f0f0f0;\n  display: inline-block;\n}\n\n#match_container {\n  position: relative;\n  top: 0;\n}\n\n#match_form {\n  position: absolute;\n  top: 3em;\n  right: -1em;\n  padding: 2em;\n  width: 33em;\n  height: 22em;\n  background-color: #f0f0f0;\n}\n\n.restaurant-image img {\n  width: 14.286em;\n  height: 14.286em;\n  -webkit-transition: width 1s;\n  transition: width 1s;\n}\n\n.restaurant-image img:hover {\n  width: 17.857em;\n  height: 17.857em;\n  object-fit: none; /* Do not scale the image */\n  object-position: center; /* center the image within the element */\n  \n}\n\n.restaurant-image {\n  display: inline-block;\n}\n\n#restaurant_images,\n#restaurant_location {\n  vertical-align: middle;\n  display: inline-block;\n}\n\n#restaurant_images {\n  position: absolute;\n  height: 17.857em;\n  right: 0;\n}\n\n.info-row {\n  margin-top: 2em;\n}\n\n#reviews_container,\n#restaurant_details {\n  width: 32.5em;\n  display: inline-block;\n  vertical-align: top;\n}\n\n#restaurant_details {\n  padding: 0em 2em 2em 2em;\n}\n\n#reviews_container {\n  padding: 0em 2em 2em 0em;\n  border-right: solid #f0f0f0 1px;\n  margin-bottom: 5em;\n}\n\n#restaurant_reviews {\n  list-style: none;\n  padding: 0;\n}\n\n.review-profile-pic,\n.review-first-name,\n.review-body {\n  display: inline-block;\n  vertical-align: top;\n}\n\n.review-first-name {\n  padding: 0em 1em 0em 1em;\n}\n\n#restaurant_details th {\n  width: 30%;\n  padding: 0.5em 0em 0.5em 0em;\n}\n\n#match_stats {\n  padding: 1em 1em 1em 1em;\n}\n\n#match_stats h3,\n#match_stats .stat-description {\n  display: inline-block;\n}\n\n.stat-description {\n  padding-left: 1em;\n}\n\n</style>\n');}return __p.join('');};
}).call(this);
...
// NOTE - localization doesn't work
var t = {
	'landing.title': "一番頼もしいグルメサイト",
	'landing.win': "優勝",
	'landing.never_been': "行ったこどがない",
	'landing.draw': "引き分け",
	'category': "ジャンル",
	'area': "エリア"
}
